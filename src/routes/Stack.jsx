...
function Stack() {
    return (
        <NavigationContainer>
            <StackScreens.Navigator initialRouteName='Calculator' screenOptions={{headerShown:false,headerShadowVisible:false}}>
                ...
                <StackScreens.Screen name='Calculator' component={Calculator} options={{
                    ...
                    headerTitleStyle: { color: Colors.primary, fontFamily: "DSDRegular", fontSize: Size.fontSize.header },
